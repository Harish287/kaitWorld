      ...
      <header>
        ...
        <div className="nav-area relative">
          <Link to="/" className="logo flex items-center relative container">
            <img className="w-[60px] mt-[14px]" src={Kiat} alt /> <p style={{ fontFamily: "Nunito,sans-serif" }} className=" text-white text-[15px] lg:text-[30px] font-extrabold lg:ml-[-10px] md:ml-[0px] md:text-[15px] sm:ml-[0px] sm:text-[15px]">KaitWorld</p>
          </Link>
