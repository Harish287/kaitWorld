...
const Silver = () => {
  ...
  useEffect(() => {
    // silverClubRef.current.scrollIntoView();
    setTimeout(() => silverClubRef.current.scrollIntoView({ behavior: 'smooth' }), 1000);
  ...
  return (
    <div>
      ...
      <h1 ref={silverClubRef} className="flex justify-center text-xl font-bold mt-9 mb-9"  > Silver Club</h1>
